...
lme1 = fitlme(tb1,'depen_var ~ 1 + age_m + child_age + sex + preterm +BMI + status + race + income + education ');
lme2 = fitlme(tb1,'depen_var ~ 1 + age_m^2 + child_age + sex + preterm + BMI + status + race + income + education');
